...
def Widgets():
    ...
    link_label = Label(root, text="YouTube link :", bg="orange", pady=5, padx=5)
    ...
    destination_label = Label(root, text="Destination :", bg="orange", pady=5, padx=9)
    ...
    browse_B = Button(
        root, text="Browse", command=Browse, width=10, bg="orange", relief=GROOVE
    )
...
def Download():
    ...
    messagebox.showinfo("GG Alin", "Saved in\n" + download_Folder)
